...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        # 1. Create Colleges first (Programs need Colleges)
        self.create_colleges(10)
        
        # 2. Create Programs next (Students need Programs)
        self.create_programs(10)
        
        # 3. Create Organizations (some need Colleges)
        self.create_organization(10)
        
        # 4. Create Students (needs Programs)
        self.create_students(50)
        
        # 5. Create Memberships (needs Students and Orgs)
